...
var Terminal = function(elem, options) {
  ...
  this.ps1Str = '<span class="terminal-green">guest</span>@<span class="terminal-red">localhost</span>:<span class="terminal-yellow">|PWD|</span>$&nbsp;';
  ...
  if (options) {
    if ('issue' in options) {
      ...
      this.print('login: '+today.toDateString(), true);
    }
